...
All of this code was written using Python 3. The command-line tool uses only code from the python standard library, but for the web app, you'll need to install Flask
...
- `python notes.py -n ID` to view a single note.
...
This code is freely available under the terms of the MIT license. See the included `LICENSE.txt` file.
